...
import { Defend, DefendCreateResponse, DefendCreateWorkflowParams, DefendResponse, DefendRetrieveEventParams, DefendRetrieveWorkflowParams, DefendSubmitAndStreamEventParams, DefendSubmitAndStreamEventResponse, DefendSubmitEventParams, DefendUpdateResponse, DefendUpdateWorkflowParams, WorkflowEventDetailResponse, WorkflowEventResponse } from './resources/defend';
import { FileResponse, FileUploadParams, Files } from './resources/files';
import { Monitor, MonitorCreateParams, MonitorCreateResponse, MonitorDetailResponse, MonitorEventDetailResponse, MonitorEventResponse, MonitorRetrieveEventParams, MonitorRetrieveParams, MonitorSubmitEventParams, MonitorUpdateParams, MonitorUpdateResponse } from './resources/monitor';
...
export interface ClientOptions {
  /**
   * Defaults to process.env['DEEPRAILS_API_KEY'].
   */
...
export class DeepRails {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.deeprails.com`,
    };
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('DEEP_RAILS_LOG'), 'process.env[\'DEEP_RAILS_LOG\']', this) ?? defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.deeprails.com';
  }
