...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: DeepRails): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: DeepRails): Logger {
